...
<img style="margin-right: 10%; margin-top:1%;" src="${url}/assets/logo.png" align="left"/>
<div align="right"></div>
<div align="right"> <h4><p>${date}</h4></div>
<br/>
<center><h3><pre style="font-size: 16px;">Bonjour, Mr/Mme l'entrepreneur(se)</pre></h3>
 <h3>Votre entreprise n'est pas éligible !</h3>
</center>
<br/>
