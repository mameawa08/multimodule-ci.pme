...
<br/>
   <p style="margin-left: 2%; margin-right: 2%;"> Vous pouvez cliquer sur le lien suivant pour vous <a href="${url}">connecter</a> à l'application en utilisant les paramétres suivants :</p>
   <br/>
   <center>
