...
<br/><br/><br/><br/><br/>
<center><h3><pre style="font-size: 16px;">Bonjour, ${prenomUser} ${nomUser}</pre> Nous vous informons que vos informations ont été modifiées sur l'application SCORING CIPME.</h3></center>
<br/>
   ...
   <br/>
   <center>
   <pre style="font-size: 16px;">Prénom: ${prenomUser}</pre>
