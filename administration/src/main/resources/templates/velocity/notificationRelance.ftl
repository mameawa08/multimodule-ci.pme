...
<div align="right"> <h4 style="color: red"><p>Réponse à envoyer pour le ${dateTraitement}</h4></div>
<br/>
<center><h3><pre style="font-size: 16px;">Bonjour, ${prenomUser} ${nomUser}</pre></h3>
 ...
 <h2>vous a été imputé</h2>
  <h2>Merci d'y apporter une réponse dans ${dateSynthese} jours</h2>
 </center>
<br/>
